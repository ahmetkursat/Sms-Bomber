...
def checkinternet():
    ...
    try:
        ...
        res = True
    if res:
        print("\n\n\tİnternetin Çok Yavaş....")
        print('\t\tBomber sımdı durduruluyor - Bomber Will Stop Now...\n\n')
        banner()
        exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Üzgünüz, Tüm APIlerin Süresi Doldu Lütfen Bomberı Güncelleyin-Sorry All APIs Have Expired Please Update bomber')
                input('Çıkmak için Entera basın -Press Enter To Exit...')
                exit()
            else:
                if success > 0:
                    print(
                        '\n\n\t  Ülkeniz İçin Bombalama Limitine Ulaşıldı -Bombing Limit For Your Country Has Been Reached...')
                    print(
                        '\nUluslararası Limiti Artırmak İçin Çok Çalışıyoruz-We Are Working Too Hard To Increase The International Limit...')
                    input(
                        '\nBu, ülkenize hızlı bir şekilde destek vermemize yardımcı olacaktır...\n\nÇıkış için Entera basın... --This will help us to give support to your country fast...\n\nPress Enter To Exit...')
                    os.system('rm *.xxx* > /dev/null 2>&1')
                    print('\n\n')
                    banner()
                    exit()
                else:
                    print('\n\n\tÜzgünüz, Ülkeniz Desteklenmiyor-Sorry Your Country is Not Supported...')
                    print(
                        '\t\tBize Haber Vermek İçin Lütfen kdsec@gmail.com E-Posta Adresine Gönderiniz...--Please Send A Mail To kdsec@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        print(random.choice(colors))
        print("==================================================================")
        print("     We Are Bombing On The Number, Have Patience!! - -Numarayı Bombalıyoruz, Sabırlı Olun!! Bombalama sırasında veri bağlantınızı aktif tutun             ")
        print("     Keep your data connection active during bombing - - Bombalama sırasında veri bağlantınızı aktif tutun !!    ")
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("             Number  On Bombing-Bombalama Sayısı         : +" + str(cc) + " ", target)
        print("             Number of Bombs Sent-Gönderilen Bomba Sayısı        : ", requested)
        print("             Successful Bombs-Başarılı Bombalar         : ", success)
        print("             Failed Bombs -Başarısız Bombalar               : ", failed)
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("==================================================================")
        try:
...
def update():
    ...
    for fl in stuff_to_update:
        ...
        file.write(dat)
        file.close()
    print('\n\t\tBaşarıyla Güncellendi--Updated Successfull !!!!')
    print('\tKomut Dosyasını Tekrar Çalıştırın --Run The Script Again...')
    exit()
...
if not cc.strip() == "91":
    if type == 1:
        print(
            '\t\tSorry Call Bombing is Not Supported In Your Region--Maalesef Çağrı Bombalama Bölgenizde Desteklenmiyor!!!!')
        print()
        input('Press Enter To Exit....')
        print('\n\n')
        banner()
    ...
    if pn.strip() == '' or dl <= 0 or nm <= 0 or cc.strip() == '' or cc.find('+') != -1:
        print('\n\n\tWrong Inputs Detected--yanlıs gırıs algılandı...')
        input('\n\t\tPress Enter To Exit...')
        banner()
        exit()
    ch = [0, 14, 15, 16]
...
if pn.strip() == '' or dl <= 0 or nm < 0:
    print('\n\n\tWrong Inputs Detected--Yanlış Girişler Algılandı...')
    input('\n\t\tPress Enter To Exit...')
    banner()
    exit()
if type == 1:
    print("NOTE: Call Bomb Might Not Work on DND Activated Numbers--NOT: Call Bomb, DND Aktif Numaralarda Çalışmayabilir...\n")
...
if cbomb:
    ...
    exit()
if nm == 0:
    nt = int(input("\tNumber Of Threads(10 to 20)--Cekırdek sayısı(10 ila 20 arasında) : "))
    if nt <= 0 or nt >= 30:
        print('\tPBomb Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing--bombacı 10 ila 25 Konuda Daha İyi Sonuç Gösteriyor\n\t\tHala Devam Ediyor....')
    print("\n\nPlease Remember That This Is in Experimental Stage And Is Incredibly Fast--Lütfen Bunun Deney Aşamasında Olduğunu ve İnanılmaz Hızlı Olduğunu Unutmayın...")
    t = [None] * nt
    print(random.choice(colors))
    print("\n\n==================================================================")
    print("                Gearing Up Bomber, please wait--Hızlandırılmış Bombacı, lütfen bekleyin !!               ")
    print("     Please keep your data connection active during bombing -Lütfen bombalama sırasında veri bağlantınızı aktif tutun !!    ")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("             Target Number       : +91", pn)
    print("             Number of Threads   : ", nt)
    print("             Delay               : ", dl)
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("      Use It for fun, Using For Revenge Is Strictly Prohibited --Eğlenmek İçin Kullanın, İntikam İçin Kullanmak Kesinlikle Yasaktır!!  !!                ")
    print("              This Bomber Is Maintained By Kdsec --Bu Bombardıman Uçağının Bakımı Kdsec Tarafından Yapılıyor!!                ")
    print("==================================================================")
    print(W)
    input('\n\nPress CTRL+Z To STOP Bomber... \nPress Enter To Begin Bomber...-Bombacıyı DURDURMAK için CTRL+Zye basın... \nBombardıman uçağını başlatmak için Entera basın...\n')
    os.system('rm *.xxx* > /dev/null 2>&1')
    print("\n\nBegining Bomber-Başlangıc ​​Bombacısı....")
    for i in range(nt):
    ...
    while True:
        ci += 1
        l = count_inf
        print("    Total Number of Bombs Sent -Gönderilen Toplam Bomba Sayısı : ", l)
        if int(l) > maxlim:
            print('\n\n\t- ' +
                  str(maxlim) + ' SMS At Once...-Tek seferde SMS\n\n')
            input('Press Enter To Exit...')
            os.system('rm *xxx* > /dev/null 2>&1')
            banner()
            exit()
